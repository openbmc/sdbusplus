        ...
        sd_bus_error* error)
{
    ...
    % endif
    {
        return sdbusplus::sdbuspp::property_callback<${property.cppTypeParam(interface.name)}()>(
                reply, o->_intf, error,
                [=]()
                {
        ...
        sd_bus_error* error)
{
    ...
    % endif
    {
        return sdbusplus::sdbuspp::property_callback<void(${property.cppTypeParam(interface.name)}&&)>(
                value, o->_intf, error,
