...
{
    // append empty string
    EXPECT_EQ(sdbusplus::message::object_path("/") / "",
              sdbusplus::message::object_path("/error_empty_string_append"));
    EXPECT_EQ(
        sdbusplus::message::object_path("/abc") / "",
        sdbusplus::message::object_path("/abc/error_empty_string_append"));
...
TEST(MessageTypes, ObjectPathOperatorSlashEqual)
{
    ...
    sdbusplus::message::object_path path3("/xyz");
    path3 /= "";
    EXPECT_EQ(path3, sdbusplus::message::object_path(
                         "/xyz/error_empty_string_append"));
}
