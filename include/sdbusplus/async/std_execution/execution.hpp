...
struct __sender
{
  ...
  private:
    ...
    struct __operation
    {
        ...
        static auto __connect_children(__operation* __self,
                                       _WhenAll&& __when_all,
        ...
        using __child_op_states_tuple_t = decltype(__connect_children(
            nullptr, __declval<_WhenAll>(), _Indices{}));
