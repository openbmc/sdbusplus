...
{
    ASSERT_EQ(sdbusplus::message::object_path("/abc/def").filename(), std::optional<std::string>("def"));
    ASSERT_EQ(sdbusplus::message::object_path("/abc/").filename(), std::nullopt);
    ASSERT_EQ(sdbusplus::message::object_path("/abc").filename(), std::optional<std::string>("abc"));
...
{
    ASSERT_EQ(sdbusplus::message::object_path("/abc/def").parent_path(), std::optional<std::string>("/abc"));
    ASSERT_EQ(sdbusplus::message::object_path("/abc/").parent_path(), std::nullopt);
    ASSERT_EQ(sdbusplus::message::object_path("/abc").parent_path(), std::optional<std::string>("/"));
