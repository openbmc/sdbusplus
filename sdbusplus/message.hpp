...
class message
{
  ...
  public:
    ...
    message(msgp_t m, std::unique_ptr<sdbusplus::SdBusInterface> intf) :
    ...
    explicit message(msgp_t m) :
        message(m, std::make_unique<sdbusplus::SdBusImpl>())
    {
    }
    ...
    message(msgp_t m, std::false_type) :
        _intf(std::make_unique<sdbusplus::SdBusImpl>()), _msg(m)
    {
    }
    ...
    {
        sdbusplus::message::append(_intf.get(), _msg.get(),
    ...
    {
        sdbusplus::message::read(_intf.get(), _msg.get(),
                                 std::forward<Args>(args)...);
    }
