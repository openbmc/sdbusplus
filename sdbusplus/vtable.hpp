...
{
    vtable_t t = SD_BUS_VTABLE_START(flags);
    return t;
}

constexpr vtable_t end()
{
    vtable_t t = SD_BUS_VTABLE_END;
    return t;
}
...
{
    vtable_t t = SD_BUS_METHOD(member, signature, result, handler, flags);
    return t;
}
...
constexpr vtable_t method_o(const char* member, const char* signature,
                            ...
                            decltype(vtable_t::flags) flags)
{
    vtable_t t = SD_BUS_METHOD_WITH_OFFSET(member, signature, result, handler,
                                           offset, flags);
    return t;
}
...
constexpr vtable_t signal(const char* member, const char* signature,
                          decltype(vtable_t::flags) flags)
{
    vtable_t t = SD_BUS_SIGNAL(member, signature, flags);
    return t;
}
...
constexpr vtable_t property(const char* member, const char* signature,
                            ...
                            decltype(vtable_t::flags) flags)
{
    vtable_t t = SD_BUS_PROPERTY(member, signature, get, 0, flags);
    return t;
}
...
{
    vtable_t t =
        SD_BUS_WRITABLE_PROPERTY(member, signature, get, set, 0, flags);
    return t;
}
...
{
    vtable_t t = SD_BUS_PROPERTY(member, signature, nullptr, offset, flags);
    return t;
}
...
constexpr vtable_t property_o(const char* member, const char* signature,
                              ...
                              decltype(vtable_t::flags) flags)
{
    vtable_t t = SD_BUS_WRITABLE_PROPERTY(member, signature, nullptr, set,
                                          offset, flags);
    return t;
}
