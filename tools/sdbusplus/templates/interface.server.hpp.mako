...
class ${interface.classname} :
    public sdbusplus::bindings::common::${interface.cppNamespacedClass()}
{
    public:
...
using sdbusplus::bindings::server::
        ${interface.cppNamespace()}::${interface.classname};
    % if interface.enums:
using sdbusplus::bindings::common::
        ${interface.cppNamespace()}::convertForMessage;
    % endif
