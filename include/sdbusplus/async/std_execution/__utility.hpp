...
struct __defer
{
    ...
    requires requires
    {
        typename _T<_A, _B, _C>;
    }
    struct __f_<_A, _B, _C>
    {
    ...
    requires requires
    {
        typename _T<_A, _B, _C, _D>;
    }
    struct __f_<_A, _B, _C, _D>
    {
    ...
    requires requires
    {
        typename _T<_A, _B, _C, _D, _E>;
    }
    struct __f_<_A, _B, _C, _D, _E>
    {
...
struct __concat
{
    ...
    requires(sizeof...(_As) == 0) &&
        __minvocable<_Continuation, _As...> struct __f_<_As...>
    {
...
template <class... _As>
requires(sizeof...(_As) != 0) struct __front;
...
template <class... _As>
requires(sizeof...(_As) == 1) using __single_t = __t<__front<_As...>>;
template <class _Ty>
struct __single_or
{
    template <class... _As>
    requires(sizeof...(_As) <= 1) using __f = __t<__front<_As..., _Ty>>;
};
