...
template <bool BadProperty, typename Container, typename... Args>
std::conditional_t<BadProperty, std::optional<std::string>, bool>
    unpackPropertiesCommon(Container&& input,
                           Args&&... args) noexcept(BadProperty)
{
