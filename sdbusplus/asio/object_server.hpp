...
enum class SetPropertyReturnValue : int
{
    fail = 0,
    success = 1,
    successSkipSignal = 2,
  ...
  public:
    ...
    SetPropertyReturnValue call(message::message& m) override
    {
        ...
        if (func_(input, *value_))
        {
            if (oldValue == *value_)
            {
                return SetPropertyReturnValue::successSkipSignal;
            }
            return SetPropertyReturnValue::success;
        }
  ...
  public:
    ...
    bool set_property(const std::string& name, const PropertyType& value)
    {
        ...
        if (func != callbacksSet_.end())
        {
            ...
            if (status >= SetPropertyReturnValue::success)
            {
                if (status != SetPropertyReturnValue::successSkipSignal)
                {
