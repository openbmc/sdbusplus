...
class in_place_stop_source
{
  ...
  private:
    ...
    bool __try_add_callback_(
        __detail::__in_place_stop_callback_base*) const noexcept;
...
class in_place_stop_callback : __detail::__in_place_stop_callback_base
{
  public:
    ...
    explicit in_place_stop_callback(
        ...
        __detail::__in_place_stop_callback_base(
  ...
  private:
    static void
        __execute_impl_(__detail::__in_place_stop_callback_base* cb) noexcept
    {
    ...
    equality_comparable<_Token> && requires(const _Token& __token)
{
    ...
    typename __detail::__check_type_alias_exists<
...
concept stoppable_token_for =
    stoppable_token<_Token> && __callable<_Callback> && requires
{
