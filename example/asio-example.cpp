...
// The server's connection, published here so method handlers registered as
// plain functions (rather than lambdas that capture it) can reach the io
// context.  A real service would hold this as a member of the class that owns
// the interface and register a member function.
