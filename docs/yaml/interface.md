...
- serviceNames
  - A list of service names which can host this D-Bus interface.
...
```yaml
paths:
  - name: GreenColorCardBack
    description: >
      The path for green color card deck
    value: /xyz/openbmc_project/card_back/green_color
  - name: RedColorCardBack
    description: >
      The path for red color card deck
    value: /xyz/openbmc_project/card_back/red_color
```

## Service Names

A service name must have the YAML property `name` & `value` and may optionally
have a `description`.
...
```yaml
service_names:
  - name: GreenColorCardBackManager
    description: >
      The service name for green card back manager.
    value: com.openbmc_project.green_card_back_manager
  - name: RedColorCardBackManager
    description: >
      The service name for red card back manager.
    value: com.openbmc_project.red_card_back_manager
```
