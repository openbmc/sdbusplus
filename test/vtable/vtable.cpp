...
extern "C" {
extern int test_handler(sd_bus_message* m, void* userdata,
                        sd_bus_error* ret_error);
extern int test_get(sd_bus* bus, const char* path, const char* interface,
                    const char* property, sd_bus_message* reply, void* userdata,
                    sd_bus_error* ret_error);
extern int test_set(sd_bus* bus, const char* path, const char* interface,
