...
TEST(MessageTypes, ObjectPathFilename)
{
    ...
    EXPECT_EQ(sdbusplus::object_path("/abc").filename(), "abc");
    ...
    EXPECT_EQ(sdbusplus::object_path("/_2F").filename(), "/");
    EXPECT_EQ(sdbusplus::object_path("/_").filename(), "");
    EXPECT_EQ(sdbusplus::object_path("/_2").filename(), "");
    EXPECT_EQ(sdbusplus::object_path("/_2y").filename(), "");
    EXPECT_EQ(sdbusplus::object_path("/_y2").filename(), "");
    EXPECT_EQ(sdbusplus::object_path("/bios_active").filename(), "bios_active");
}

TEST(MessageTypes, ObjectPathParent)
{
    EXPECT_EQ(sdbusplus::object_path("/abc/def").parent_path(),
              sdbusplus::object_path("/abc"));
    EXPECT_EQ(sdbusplus::object_path("/abc/").parent_path(),
              sdbusplus::object_path("/abc"));
    EXPECT_EQ(sdbusplus::object_path("/abc").parent_path(),
...
{
    // append empty string
    EXPECT_EQ(sdbusplus::object_path("/") / "",
              sdbusplus::object_path("/error_empty_string_append"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "",
              sdbusplus::object_path("/abc/error_empty_string_append"));

    EXPECT_EQ(sdbusplus::object_path("/") / "abc",
              sdbusplus::object_path("/abc"));
    EXPECT_EQ(sdbusplus::object_path("/") / "abc",
              sdbusplus::object_path("/abc"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "def",
              sdbusplus::object_path("/abc/def"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "-",
              sdbusplus::object_path("/abc/_2d"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / " ",
              sdbusplus::object_path("/abc/_20"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "/",
              sdbusplus::object_path("/abc/_2f"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "ab_cd",
              sdbusplus::object_path("/abc/ab_cd"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "_ab_cd",
              sdbusplus::object_path("/abc/_5fab_5fcd"));
    EXPECT_EQ(sdbusplus::object_path("/abc") / "ab-c_d",
              sdbusplus::object_path("/abc/_61b_2dc_5fd"));

    // Test the std::string overload.  This is largely just for coverage
    EXPECT_EQ(sdbusplus::object_path("/") / std::string("abc"),
              sdbusplus::object_path("/abc"));
}
...
TEST(MessageTypes, ObjectPathOperatorSlashEqual)
{
    ...
    path /= "abc";
    EXPECT_EQ(path, sdbusplus::object_path("/abc"));
    ...
    path3 /= "";
    EXPECT_EQ(path3, sdbusplus::object_path("/xyz/error_empty_string_append"));
}
