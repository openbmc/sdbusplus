  ...
  public:
    ...
    inline BOOST_ASIO_INITFN_RESULT_TYPE(MessageHandler,
                                         void(boost::system::error_code,
                                              message::message&))
        async_send(message::message& m, MessageHandler&& handler, uint64_t timeout = 0)
    {
     ...
     *          complete.
     */
    template <uint64_t Timeout = 0, typename MessageHandler, typename... InputArgs>
                           ...
                           const InputArgs&... a)
    {
        ...
        async_send(m, std::forward<decltype(applyHandler)>(applyHandler), Timeout);
    }
